                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="product_unit" value="{{ $product->product_unit }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="pv" class="form-label">PV</label>
                                        <input type="text" class="form-control" name="pv" value="{{ $product->pv }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="6" name="product_description"> {{ $product->product_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select id="er" class="form-select" name="er" required>
                                            <option value="YES" {{ $product->er == "YES" ? "selected" : "" }}>YES</option>
                                            <option value="NO" {{ $product->er == "NO" ? "selected" : "" }}>NO</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="with_limit_qty" class="form-label">With Limit Qty</label>
                                        <input type="text" class="form-control" name="with_limit_qty" value="{{ $product->with_limit_qty }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select id="qo" class="form-select" name="qo" required>
                                            <option value="YES" {{ $product->qo == "YES" ? "selected" : "" }}>YES</option>
                                            <option value="NO" {{ $product->qo == "NO" ? "selected" : "" }}>NO</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select id="points" class="form-select" name="points" required>
                                            <option value="YES" {{ $product->points == "YES" ? "selected" : "" }}>YES</option>
                                            <option value="NO" {{ $product->points == "NO" ? "selected" : "" }}>NO</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="enabled" class="form-label">Enabled</label>
                                        <select id="enabled" class="form-select" name="enabled" required>
                                            <option value="1" {{ $product->enabled == "1" ? "selected" : "" }}>YES</option>
                                            <option value="0" {{ $product->enabled == "0" ? "selected" : "" }}>NO</option>
                                        </select>
                                    </div>
